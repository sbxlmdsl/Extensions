//-----------------------------------------------------------------------
// <copyright file="XMLSerializerGenericTests.cs" company="Genesys Source">
...
namespace Genesys.Extras.Test
{
    ...
    public class XMLSerializerGenericTests
    {
        ...
        [TestMethod()]
        public void Serialization_XmlGeneric_Serialize()
        {
        ...
        [TestMethod()]
        public void Serialization_XmlGeneric_Deserialize()
        {
            var serializer = new XmlSerializer<MyClass>();
