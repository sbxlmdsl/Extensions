...
REM *** Source DLLs
REM ***
SET ExtensionsUniversal=%BuildLocationBin%\Genesys.Extensions.Core.dll
SET ExtensionsFull=%BuildLocationBin%\Genesys.Extensions.Standard.dll
SET ExtrasUniversal=%BuildLocationBin%\Genesys.Extras.Core.dll
SET ExtrasFull=%BuildLocationBin%\Genesys.Extras.Standard.dll

REM ***
REM *** Destination DLLs
REM ***
REM *** Runtimes
SET ExtensionsUniversalLib=%BuildLocationLib%\Genesys.Extensions.Core.dll
SET ExtensionsFullLib=%BuildLocationLib%\Genesys.Extensions.Standard.dll
